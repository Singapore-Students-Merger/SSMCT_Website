...
export default function Footer() {
    return (
        <footer className=" text-white bg-gray-800/80 text-xl font-bold py-4 w-full">
            <div className="flex gap-12 justify-start md:justify-center w-full flex-wrap px-4">
                ...
                <Link target ="_blank" href="https://discord.gg/p5HgEmp7A6" className='cursor-pointer hover:brightness-75 transition-all duration-500 flex gap-2 justify-center items-center'>
                    <SocialIcon as="div" network="discord" url="https://discord.gg/p5HgEmp7A6" />
                        CTF Discord
                </Link>
