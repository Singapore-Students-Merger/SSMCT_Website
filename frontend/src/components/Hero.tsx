    ...
    return (
        <div className={twMerge('w-full h-screen bg-center bg-cover bg-no-repeat',className)}>
            ...
            <div className="flex flex-col items-center justify-center h-full pb-20 gap-10">
                <Logo className="animate-fadeIn-top animation-delay-200 w-60 md:w-72 "/>
                <div className="flex items-center flex-col gap-6">
                    <div className = "flex justify-center relative animate-fadeIn-bottom animation-delay-200">
                        <p className="w-full animation-delay-1500 animate-title-br text-4xl font-bold text-center absolute left-1/2 -translate-x-1/2 mx-1 my-0.5 text-[#FF1818]! ">{title}</p>
                        <p className="animation-delay-1500 animate-title-tl text-4xl font-bold text-center w-full absolute left-1/2 -translate-x-1/2 -mx-1 -my-0.5 text-transparent! [text-fill-color:transparent]! [-webkit-text-stroke:1px_#00FEFC] ">{title}</p>
                    ...
                    <Link href="https://discord.gg/SWAwuFVQ6M">
                        ...
                        } version="primary" className="text-2xl w-64 animate-fadeIn-bottom animation-delay-1500">Join Us
                        </Button>
                    </Link>
                </div>
            </div>
