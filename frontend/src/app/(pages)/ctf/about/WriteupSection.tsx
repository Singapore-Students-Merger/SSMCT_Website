        ...
        <SectionElement className='px-8 md:px-32'>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-36 gap-y-12 mt-16">
                <div className="md:col-span-2 flex flex-col justify-center items-center h-full gap-4">
                    ...
                    <p className="text-4xl font-bold header-border">XX$ Cash Prize</p>
                </div> 
                <div className="flex flex-col justify-center items-center h-full gap-4">
                    <h3 className={`text-4xl font-bold second-place ${inView?"fade-in-text-border":"remove-text-border"}`}>2nd Place</h3>
                    <p className="text-4xl font-bold header-border">XX$ Cash Prize</p>
                </div >
                <div className="flex flex-col justify-center items-center h-full gap-4">
                    <h3 className={`text-4xl font-bold third-place ${inView?"fade-in-text-border":"remove-text-border"}`}>3rd Place</h3>
                    <p className="text-4xl font-bold header-border">XX$ Cash Prize</p>
                </div>
            </div>
        </SectionElement>
