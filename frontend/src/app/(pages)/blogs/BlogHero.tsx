...
export default function BlogHero({featured}: BlogHeroProps) {
    return (
        <div className="h-[80vh] md:h-[70vh] w-full bg-secondary-tier3/80 box-border px-8 py-8 lg:px-16 lg:py-24 gap-8 items-start flex flex-col md:flex-row md:items-center md:gap-16">
            ...
            <div className="relative z-10 flex flex-col justify-start gap-2 items-start flex-grow-0 w-full">
                ...
                <Link href={`/blogs/views/${featured.id}`} className="mx-auto lg:mx-0 block">
