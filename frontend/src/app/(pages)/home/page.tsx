...
export default function Home() {
  ...
  const sections = [
    ...
    {
      title: "Our Active CTF Players",
      text: <>We compete in CTFs <strong>almost every weekend</strong>, motivating each other to compete internationally. <br /> <br />Some
    ...
    {
      title: "SSMCT Blogs and Writeups",
      text: <>
        Our members regularly publish <strong>blog posts</strong> and detailed <strong>CTF writeups</strong>, sharing <strong>insights</strong>, <strong>techniques</strong>, and <strong>lessons</strong> to help others learn and grow in cybersecurity.
      </>,
      aftText: <div className="flex flex-col lg:flex-row gap-4 mt-4">
        <Button className="px-4" version="secondary">View Blogs</Button>
        <Button className="px-4" version="secondary">View Writeups</Button>
      </div>,
      imgSrc: "/assets/home/about5.png",
      imgAlt: "Blogs and Writeups",
      description: "SSMCT members sharing their writeups and blogs on the SSMCT website"
    }
  ];
  ...
  return (
    <>
      <ArticleJsonLd
        useAppDir={true}
        url="https://ssmct.org/" // Update to your actual canonical URL
        title="Singapore Students Merger CTF Team (SSMCT)"
        images={[
          'https://ssmct.sg/assets/home/about1.png',
          'https://ssmct.sg/assets/home/about2.png',
          'https://ssmct.sg/assets/home/about5.png'
        ]}
        datePublished="2024-03-01T08:00:00+08:00"
        dateModified="2025-03-01T08:00:00+08:00"
        authorName={[
          {
            name: 'Singapore Students Merger (SSMCT)',
            url: 'https://ssmct.sg'
          }
        ]}
        publisherName="SSMCT"
        publisherLogo="https://ssmct.sg/assets/logo.svg" // Use a real logo URL here
        description="Singapore Students Merger (SSMCT) is a student-led CTF team that competes, organizes, and shares cybersecurity knowledge across Singapore."
      />
      <div>
        {/* Hero Section */}
  ...
  return (
    <section ref={ref} className={twMerge(sectionClasses, left ? "" : "lg:!flex-row-reverse")}>
      ...
      <div className={twMerge("text-center lg:text-left lg:w-1/2", inView ? "animate-fadeIn-right" : "opacity-0")}>
        ...
        <div className="mb-6">
          <p className="text-lg lg:text-xl">{section.text}</p>
          {section.aftText}
        </div>
      </div>
